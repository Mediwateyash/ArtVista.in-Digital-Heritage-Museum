document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('cardPaymentForm')?.addEventListener('submit', handlePaymentSubmission);
    document.getElementById('upiPaymentForm')?.addEventListener('submit', handlePaymentSubmission);
    document.getElementById('netBankingPaymentForm')?.addEventListener('submit', handleNetBankingSubmission);
    ...
    window.downloadTicket = function() {
        ...
        // Real implementation might use libraries like jsPDF or html2canvas
        // Example:
        // html2canvas(document.getElementById('generatedTicket')).then(canvas => {
        //     const link = document.createElement('a');
        //     link.download = 'ArtVasta-Ticket.pdf';
